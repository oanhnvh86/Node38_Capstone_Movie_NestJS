...
export class TheaterController {
  ...
  async getTheaterSystemListPerPage(
    @Param('page') page,
    @Param('size') size,
  ): Promise<any> {
  ...
  async getClusterTheaterBySystem(
  ...
  async getClusterTheaterBySystemPerPage(
    ...
    return this.theaterService.getClusterTheaterBySystemPerPage(
      theater_id,
      page,
      size,
    );
